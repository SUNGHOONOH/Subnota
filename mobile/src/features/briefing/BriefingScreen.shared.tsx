...
export interface BriefingPlatformConfig {
  keyboardAvoidingBehavior: 'padding' | 'height' | undefined;
  titleFontSize: number;
  contentMaxWidth: number | undefined;
  contentAlignSelf: 'center' | undefined;
  contentWidth: '100%' | undefined;
  detailPanelMaxWidth: number | undefined;
}
...
const BriefingScreenShared = ({ platformConfig }: { platformConfig: BriefingPlatformConfig }) => {
  ...
  const dynamicStyles = StyleSheet.create({
    title: {
      color: '#2C2520',
      fontSize: platformConfig.titleFontSize,
      fontWeight: '800',
    },
    content: {
      paddingBottom: 18,
      paddingHorizontal: 18,
      maxWidth: platformConfig.contentMaxWidth,
      alignSelf: platformConfig.contentAlignSelf,
      width: platformConfig.contentWidth,
    },
    detailPanel: {
      ...
      padding: 18,
      width: '100%',
      maxWidth: platformConfig.detailPanelMaxWidth,
    },
  });
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        <View style={styles.header}>
          <View>
            <Text style={dynamicStyles.title}>브리핑</Text>
      ...
      >
        <View style={styles.detailBackdrop}>
          <View style={dynamicStyles.detailPanel}>
...
export default BriefingScreenShared;
